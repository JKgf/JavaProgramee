...
//<input type="text" name="birthday"/>
	...
	/*
	 * validate方法负责校验表单输入项 表单输入项校验规则： private String userName; 用户名不能为空，并且要是-的字母
	 * abcdABcd private String userPwd; 密码不能为空，并且要是-的数字 private String confirmPwd;
	 * 两次密码要一致 private String email; 可以为空，不为空要是一个合法的邮箱 private String birthday;
	 * 可以为空，不为空时，要是一个合法的日期
	 */
